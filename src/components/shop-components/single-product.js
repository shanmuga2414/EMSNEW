              ...
              <div className="row">
                <div className="col-lg-5 col-md-6">
                  <div className="slider-tabfor margin-top-20">
                    <div className="single-item">
                      <img
                        src={publicUrl + "assets/img/product-details/big1.png"}
                        alt=""
                      />
                    </div>
                    <div className="single-item">
                  ...
                  <div className="slider-tabnav">
                    <div className="single-item">
                      <div className="img">
                        <img
                          src={publicUrl + "assets/img/product-details/1.png"}
                          alt=""
                        />
                      </div>
                    </div>
                ...
                <div className="col-lg-7 col-md-6">
                  <div className="content-part margin-top-20">
                    ...
                    <p className="specifications">
                      AVAILABILITY: <b className="color-green">In Stock</b>
                    </p>
                    ...
                    <div className="btn-wrapper d-flex">
                      <div className="input-group">
                        <div className="input-group-prepend align-self-center">
                          <a className="btn btn-sm" id="minus-btn">
                        ...
                        />
                        <div className="input-group-prepend align-self-center">
                          <a className="btn btn-sm" id="plus-btn">
                      ...
                      <div className="add-to-cart-style">
                        <a href="/">
                          <i className="icon-add-to-cat" /> Add to cart
                        </a>
                      </div>
                    </div>
                    ...
                    <p className="specifications">
                      CATEGORY: <b>Men, Blazer</b>
                    </p>
                    <p className="specifications">
                      TAG: <b>Men, Blazer, Casual, Classic, Elegant</b>
                    </p>
                    <div className="d-flex">
                  ...
                  <div className="product-tab">
                    ...
                    <div className="tab-content">
                      <div id="home" className="tab-pane fade in show active">
                        <p>
                          Silver, metallic-blue and metallic-lavender silk-blend
                          jacquard, graphic pattern, pleated ruffle along
                          collar, long sleeves with button-fastening cuffs,
                          buckle-fastening silver skinny belt, large pleated
                          rosettes at hips. Dry clean. Zip and hook fastening at
                          back. 100% silk. Specialist clean
                        </p>
                        <ul className="tab-list">
                          <li>
                            <a href="/">
                              <i className="icon-right-arrow-slider" />{" "}
                              Lightweight soft-touch woven
                            </a>
                          </li>
                          <li>
                            <a href="/">
                          ...
                          <li>
                            <a href="/">
                              <i className="icon-right-arrow-slider" /> Zip fly
                              with hook and button fastening
                            </a>
                          </li>
                          <li>
                            <a href="/">
                              <i className="icon-right-arrow-slider" /> Slip
                              pockets
                            </a>
                          </li>
                          <li>
                            <a href="/">
                              <i className="icon-right-arrow-slider" /> Waist
                              belt
                            </a>
                          </li>
                          <li>
                            <a href="/">
                              <i className="icon-right-arrow-slider" /> Relaxed
                              fit
                            </a>
                          </li>
                          <li>
                            <a href="/">
                              <i className="icon-right-arrow-slider" /> Machine
                              wash
                            </a>
                          </li>
                          <li>
                            <a href="/">
                              <i className="icon-right-arrow-slider" /> 76%
                              Polyester, 18% Viscose, 6% Elastane
                            </a>
                          </li>
                          <li>
                            <a href="/">
                              <i className="icon-right-arrow-slider" /> Our
                              model wears a UK 8/ EU 36/ US 4 and is 174
                              cm/5'8.5” tall
                            </a>
                          </li>
                        </ul>
              ...
              <div className="widget checkout-widget">
                ...
                <ul className="checkout-list">
                  <li>
                    <a href="/">
                      <img
                        src={publicUrl + "assets/img/payment/p1.png"}
                        alt=""
                      />
                    </a>
                  </li>
                  <li>
                    <a href="/">
                      <img
                        src={publicUrl + "assets/img/payment/p2.png"}
                        alt=""
                      />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img
                        src={publicUrl + "assets/img/payment/p3.png"}
                        alt=""
                      />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img
                        src={publicUrl + "assets/img/payment/p4.png"}
                        alt=""
                      />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img
                        src={publicUrl + "assets/img/payment/p5.png"}
                        alt=""
                      />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img
                        src={publicUrl + "assets/img/payment/p6.png"}
                        alt=""
                      />
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <img
                        src={publicUrl + "assets/img/payment/p7.png"}
                        alt=""
                      />
                    </a>
                  </li>
