...
class TrendingV2 extends Component {
  render() {
    ...
    return (
      <div className="arrivals-area margin-top-75">
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              <ul className="nav nav-pills collection-tab-02">
                <li>
                  <a data-toggle="pill" href="#hot" className="active">
                    All
                  </a>
                </li>
                <li>
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                  <div className="product-style-05 margin-top-40">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/arrival/8.png"}
                        alt=""
                      />
                    ...
                    <div className="content text-left">
                      <h6 className="title">
                        <a href="/">Faxon Canvas Low-Top Sneaker</a>
                      </h6>
                      <div
                        className="product-countdown clockdiv"
                        data-countdown="2021/02/02"
                      ></div>
                      <div className="d-flex position-relative">
                        <div className="content-hover-cart">
                          <a
                            className="add-to-cart-v2"
                            data-img="assets/img/shop/c1.png"
                            data-name="Faxon Canvas Low-Top Sneaker"
                            data-price="450"
                            href="/"
                          >
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                  <div className="product-style-05 margin-top-40">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/arrival/3.png"}
                        alt=""
                      />
                    ...
                    <div className="content text-left">
                      ...
                      <div className="d-flex position-relative">
                        <div className="content-hover-cart">
                          <a
                            className="add-to-cart-v2"
                            data-img="assets/img/shop/c2.png"
                            data-name="Viscose-Cashmere Scarf"
                            data-price="450"
                            href="/"
                          >
                            <i className="icon-add-to-cat" /> Add to cart
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                  <div className="product-style-05 margin-top-40">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/arrival/13.png"}
                        alt=""
                      />
                      <span className="sale">SALE 13%</span>
                    ...
                    <div className="content text-left">
                      ...
                      <div className="d-flex position-relative">
                        <div className="content-hover-cart">
                          <a
                            className="add-to-cart-v2"
                            data-img="assets/img/shop/c3.png"
                            data-name="Viscose-Cashmere Scarf"
                            data-price="450"
                            href="/"
                          >
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                  <div className="product-style-05 margin-top-40">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/arrival/1.png"}
                        alt=""
                      />
                      <span className="out">SOLD OUT</span>
                      <ul className="cart-action-02">
                    ...
                    <div className="content text-left">
                      ...
                      <div className="d-flex position-relative">
                        <div className="content-hover-cart">
                          <a
                            className="add-to-cart-v2"
                            data-img="assets/img/shop/c4.png"
                            data-name="Round neck sweater"
                            data-price="450"
                            href="/"
                          >
                            <i className="icon-add-to-cat" /> Add to cart
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                  <div className="product-style-05 margin-top-40">
                    <div className="thumb">
                      <img
                        src={publicUrl + "assets/img/arrival/2.png"}
                        alt=""
                      />
                      <span className="out">SOLD OUT</span>
                      <ul className="cart-action-02">
